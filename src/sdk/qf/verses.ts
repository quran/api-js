...
export type GetVerseOptions = Partial<
  BaseApiOptions & {
    reciter: string | number;
    audio?: string | number; // ✅ required for internal rename
    words: boolean;
    translations: string[] | number[];
    tafsirs: string[] | number[] | string; // ✅ allow string too
    wordFields: Partial<Record<WordField, boolean>> | string; // ✅ for .join
    translationFields: Partial<Record<TranslationField, boolean>> | string; // ✅ for .join
    fields: Partial<Record<VerseField, boolean>> | string; // ✅ also may need string
    page: number;
    perPage: number;
  }
>;
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-verse-key
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-chapter-number
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-page-number
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-juz-number
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-hizb-number
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/verses-by-rub-el-hizb-number
...
/**
 * Get a random ayah.
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/random-verse
 * @param {GetVerseOptions} options
 * @example

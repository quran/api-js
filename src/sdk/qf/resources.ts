...
/**
 * Get all recitations.
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/recitations
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/recitation-info
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/translations
 * @param {GetResourceOptions} options
 * @example
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/translation-info
...
/**
 * Get all tafsirs.
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/tafsirs
 * @param {GetResourceOptions} options
 * @example
...
/**
 * Get tafsir info.
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/tafsir-info
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/recitation-styles
 * @example
...
/**
 * Get all languages.
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/languages
 * @param {GetResourceOptions} options
 * @example
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/chapter-info
 * @param {GetResourceOptions} options
 * @example
...
/**
 * Get verse media.
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/verse-media
 * @param {GetResourceOptions} options
 * @example
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/chapter-reciters
 * @param {GetResourceOptions} options
 * @example

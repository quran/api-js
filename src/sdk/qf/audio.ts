 ...
 * @description  https://api-docs.quran.foundation/docs/content_apis_versioned/chapter-reciter-audio-files
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/chapter-reciter-audio-file
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/list-surah-recitation
 * @param {ChapterId} chapterId
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/list-juz-recitaiton
 * @param {JuzNumber} juz
 * @param {string} recitationId
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/list-page-recitaiton
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/list-rub-el-hizb-recitaiton
 * @param {RubNumber} rub
 * @param {string} recitationId
 * @param {GetVerseRecitationOptions} options
 * @example
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/list-hizb-recitaiton
 ...
 * @description https://api-docs.quran.foundation/docs/content_apis_versioned/list-ayah-recitaiton
 * @param {VerseKey} key
 * @param {string} recitationId
 * @param {GetVerseRecitationOptions} options
 * @example
